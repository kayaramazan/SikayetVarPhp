...
// Firma filter
  document.getElementById("t1").style.display="none";
        ...
        //Firma filter end
				...
				function resimac() {
					document.querySelector('.file-up').style.display="block";
					document.querySelector('.file-up').style.background="#ccc8";
				}
				function resimkapa() {
					document.querySelector('.file-up').style.display="none";
				}
				function btndgs() {
					document.querySelector('#btn-dgs').style.display="block";
				}
